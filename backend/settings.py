"""
Django settings for backend project - Configuración simple para Render
"""
...
SECRET_KEY = 'django-insecure-pastillero-2024-render-deploy-key-simple'
DEBUG = True
ALLOWED_HOSTS = ['*']
